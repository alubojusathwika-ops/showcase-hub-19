...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Alex Rivera — Independent Design Engineer & Portfolio" },
      {
        name: "description",
        content:
          "Portfolio of Alex Rivera, an independent design engineer crafting editorial digital products, brand systems, and interactive experiences.",
      },
